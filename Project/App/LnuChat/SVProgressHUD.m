...
- (void)showImage:(UIImage*)image status:(NSString*)string duration:(NSTimeInterval)duration{
    ...
    if([self.imageView respondsToSelector:@selector(setTintColor:)]){
        ...
        self.imageView.tintColor = k_mainColor;
    } else{
...
- (UIView*)hudView{
    ...
    _hudView.backgroundColor = k_lightGray;
...
- (UILabel*)stringLabel{
    ...
    _stringLabel.textColor = k_mainColor;
    _stringLabel.font = k_buttonfont;
...
- (UIImageView*)imageView{
    ...
    if(!_imageView.superview){
        _imageView.tintColor = k_mainColor;
